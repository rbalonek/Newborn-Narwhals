      ...
      <div className="sectionTwo__text">
        <Fade duration={3000} triggerOnce="true">
          <h4 style={{ lineHeight: "30px" }}>
            Rising from the deep blue sea...our baby narwhals are here to steal
            your heart Each narwhal is randomly generated and 100% unique. Are
            you ready to play our game and adopt an endangered NFT into your
            heart?
          </h4>
        </Fade>
      </div>
